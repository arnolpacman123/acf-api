...
export class OrganizationsController {
    ...
    @Post('update-clubs')
    async updateClubs(
        @Body() organizationAddClubsDto: OrganizationAddClubsDto,
    ) {
        return await this.organizationsService.updateClubs(organizationAddClubsDto.organizationId, organizationAddClubsDto.clubsIds);
    }
